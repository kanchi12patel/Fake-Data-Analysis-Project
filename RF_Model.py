...
rfor=RandomForestClassifier(random_state=579)
rfor.fit(xtrain,ytrain)
ytest=rfor.predict(xtest)

xtrainx,xtrainy,ytrainx,ytrainy=train_test_split(xtrain,ytrain,test_size=0.2,random_state=579)
rfor1=RandomForestClassifier(random_state=579)
rfor1.fit(xtrainx,ytrainx)
pred=rfor1.predict(xtrainy)
...
print("Predicted Label Frequency of the Test Dataset: ")
